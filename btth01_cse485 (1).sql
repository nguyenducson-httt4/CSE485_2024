...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 17, 2024 lúc 04:59 PM
...
CREATE TABLE `baiviet` (
  ...
  `ngayviet` datetime NOT NULL COMMENT 'Ngày hiện tại từ HT',
...
--
ALTER TABLE `tacgia`
  ADD PRIMARY KEY (`ma_tgia`) USING BTREE;
...
ALTER TABLE `baiviet`
  ...
  ADD CONSTRAINT `baiviet_ibfk_2` FOREIGN KEY (`ma_tloai`) REFERENCES `baiviet` (`ma_bviet`);
COMMIT;
